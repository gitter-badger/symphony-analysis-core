...
%     end;
    ...
    outputStruct.spikeCount_baseline.value(i) = length(baselineSpikeTimes);
...
for i=1:L
    ...
    if i==1 %some stuff we only need to do once: units and types for each output
        ...
        outputStruct.spikeCount_baseline.units = 'spikes';
        outputStruct.spikeCount_baseline.type = 'byEpoch';
        %value already set
        ...
        outputStruct.spikeCount_poststim_baselineSubtracted.units = 'spikes';
        outputStruct.spikeCount_poststim_baselineSubtracted.type = 'byEpoch';
        outputStruct.spikeCount_poststim_baselineSubtracted.value = ones(1,L) * NaN;
...
%     % % %
    ...
    outputStruct.spikeCount_poststim_baselineSubtracted.value(i) = spikeCount - outputStruct.spikeCount_baseline.value(i);
